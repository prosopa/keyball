...
#define SCROLL_LAYER 2 // must greater than AUTO_MOUSE_DEFAULT_LAYER
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [5] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  ,                                        _______  , SCRL_DVD , SCRL_DVI , _______  , _______  , _______  ,
