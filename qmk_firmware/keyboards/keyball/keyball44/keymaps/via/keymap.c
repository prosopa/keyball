...
#define SCROLL_LAYER 4 // must greater than AUTO_MOUSE_DEFAULT_LAYER
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_Z         ,    KC_X     ,     KC_C    ,    KC_V     , KC_B     ,                                        KC_N     ,     KC_M     ,     KC_COMM  ,     KC_DOT   ,        KC_SLSH  , KC_INT1  ,
                                  KC_LALT,KC_LGUI,LT(4,KC_ESC)  ,LT(1,KC_SPC),    LT(3,KC_TAB),                  KC_BSPC,LT(2,KC_ENT), RCTL_T(KC_LNG2),     KC_RALT  , KC_PSCR
  ),
  ...
  // symbol and num // TBD
  [2] = LAYOUT_universal(
    _______  ,S(KC_QUOT), KC_7     , KC_8    , KC_9     , S(KC_8)  ,                                         S(KC_7)  , S(KC_LBRC), S(KC_RBRC), S(KC_3)  , S(KC_4)  , _______  ,
  ...
  [3] = LAYOUT_universal(
    ...
    _______  ,   KC_F6   , KC_F7    , KC_F8   , KC_F9    , KC_F10   ,                                        _______  , KC_BTN1  , KC_BTN3  , KC_BTN2  , _______  , _______  ,
    _______  ,   KC_F11  , KC_F12   , _______ , _______  , _______  ,                                        _______  , KC_BTN4  , KC_BTN5  , _______  , _______  , KBC_SAVE ,
